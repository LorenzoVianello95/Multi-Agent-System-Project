...
public class Ignite extends SimState{
	...
	/* simulation params */
	public int numUAVs = 6; //number of mavs involved in the simulation
	public Bag UAVs= new Bag(); // all the agents in the simulation. Bag size is numMavs    
	...
	public static int cellsEstinguesh = 0;
	...
	public void start(){
		...
		for(int i = 0 ; i < numUAVs; i++){
			...
			try{UAVs.add(uav);}
			catch(NullPointerException e){System.err.println(uav);}
