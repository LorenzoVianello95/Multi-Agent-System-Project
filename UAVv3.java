...
*/
		...
		while(!done){
			try{newTarget = this.targetCells.getFirst();}catch(NoSuchElementException e){System.err.println("444444");done=true;}
			//if(this.mode==1){done=true;}
			...
			try{this.targetCells.removeFirst();}catch(NoSuchElementException e){System.err.println("55555");done=true;}
			}
